export const story = [
  ...
  { // Option 2
    text: 'You decide this adventure is too big to tackle alone. You dash' +
  ...
  { // Option 3
    text: 'You’re confident you can handle this on your own. With the map tucked safely in your fur, you sneak out of the house and head straight for the dock. ' +
        'he moon casts an eerie glow over the water as you “borrow” an old rowboat and set off for Bloodstone Island.',
    option:
        [
  ...
  { // 5
    text: 'You wait until nightfall to avoid being seen by the townsfolk. The sea is calm as you and your crew row' +
  ...
  {// 9
    text: 'You press on, determined to find the treasure. The cave twists' +
  ...
  {// 10
    text: 'You decide it’s best to make camp for the night. The island is dark and foreboding, ' +
  ...
  {// 13
    text: 'You and your crew work together to solve the puzzle. The pieces click into place, ' +
  ...
  {// 14
    text: 'Ignoring the puzzle, you and your crew try to force the door open. ' +
  ...
  {// 15
    text: 'Before entering the cave, you decide to explore the beach. ' +
  ...
  {// 16
    text: 'You pull the lever hidden behind the stone paw of Blackpaw. ' +
  ...
  {// 17
    text: 'You stand your ground and face the ghost of Captain Blackpaw. ' +
  ...
  {// 18
    text: 'As the ghost of Captain Blackpaw appears, you and your crew grab as much treasure as you can carry and make a run for it. ' +
  ...
  {// 19
    text: 'You enter the secret chamber and find the true heart of Captain' +
